...
RESULT_TEMP = """
<div style="width:90%;height:100%;margin:1px;padding:5px;position:relative;
box-shadow:0 0 15px 5px #ccc; background-color:#14EBEB;
...
def main():
	...
	menu = ["Course List","Recommend Course"]
	choice = st.sidebar.selectbox("Menu",menu)

	df = load_data("data/udemy_course_data.csv")

	if choice == "Course List":
		print()
		st.subheader("List of Courses Available")
